...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <h5 class="card-subtitle h6 mb-2 text-muted">Card subtitle</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
<div class="card">
  ...
  <div class="card-body">
    <h4 class="card-title h5">Special title treatment</h4>
...
{% capture example %}
<div class="card">
  <h4 class="card-header h5">Featured</h4>
  <div class="card-body">
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h3 class="card-title h5">Special title treatment</h3>
    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
</div>
...
<div class="card{% unless color.name == "light" %} text-white{% endunless %} bg-{{ color.name }} mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    <h4 class="card-title h5">{{ color.name | capitalize }} card title</h4>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
</div>{% endfor %}
{% endcapture %}
...
<div class="card border-success mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body text-success">
    <h3 class="card-title h5">Success card title</h3>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
...
<div class="card-columns">
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-title h5">Card title that wraps to a new line</h4>
      <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    </div>
  </div>
  <div class="card p-3">
