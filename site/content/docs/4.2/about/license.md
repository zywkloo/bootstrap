...
Bootstrap is released under the MIT license and is copyright {{< time.inline >}}{{ now.Format "2006" }}{{< /time.inline >}} Twitter. Boiled down to smaller chunks, it can be described with the following conditions.
